            ...
            Tokenizer.Token(
                ...
                treeSitterToken.type.lowercase().let { type ->
                    when {
                        ...
                        "integer" in type && treeSitterToken.text.length > Long.MAX_VALUE.toString().length -> Tokenizer.Token.Type.STRING // Treat Python "BigInts" as strings, as they would be in any other language
